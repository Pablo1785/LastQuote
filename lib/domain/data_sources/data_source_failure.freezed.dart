...
class _$DataSourceFailureTearOff {
  ...
  _SourceDisabled sourceDisabled(DataSource dataSource) {
...
class _$_Unexpected implements _Unexpected {
  ...
  @override
  String toString() {
    return 'DataSourceFailure.unexpected()';
  }
...
abstract class _Unexpected implements DataSourceFailure {
...
abstract class _InsufficientPermissions implements DataSourceFailure {
...
abstract class _$SourceDisabledCopyWith<$Res> {
  ...
  $Res call({DataSource dataSource});
...
class __$SourceDisabledCopyWithImpl<$Res>
  ...
  $DataSourceCopyWith<$Res> get dataSource {
    return $DataSourceCopyWith<$Res>(_value.dataSource, (value) {
      return _then(_value.copyWith(dataSource: value));
    });
  }
}
...
class _$_SourceDisabled implements _SourceDisabled {
  const _$_SourceDisabled(this.dataSource);
  ...
  @override
  String toString() {
    return 'DataSourceFailure.sourceDisabled(dataSource: $dataSource)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, dataSource);
...
abstract class _SourceDisabled implements DataSourceFailure {
  const factory _SourceDisabled(DataSource dataSource) = _$_SourceDisabled;
...
class _$_NoActiveSource implements _NoActiveSource {
  ...
  @override
  String toString() {
    return 'DataSourceFailure.noActiveSource()';
  }
