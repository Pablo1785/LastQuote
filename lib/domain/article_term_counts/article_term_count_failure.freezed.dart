...
part of 'article_term_count_failure.dart';
...
/// @nodoc
class _$ArticleTermCountFailureTearOff {
  const _$ArticleTermCountFailureTearOff();
...
/// @nodoc
const $ArticleTermCountFailure = _$ArticleTermCountFailureTearOff();

/// @nodoc
mixin _$ArticleTermCountFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ArticleTermCountFailureCopyWith<$Res> {
  factory $ArticleTermCountFailureCopyWith(ArticleTermCountFailure value,
          $Res Function(ArticleTermCountFailure) then) =
      _$ArticleTermCountFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$ArticleTermCountFailureCopyWithImpl<$Res>
    implements $ArticleTermCountFailureCopyWith<$Res> {
  _$ArticleTermCountFailureCopyWithImpl(this._value, this._then);

  final ArticleTermCountFailure _value;
  // ignore: unused_field
  final $Res Function(ArticleTermCountFailure) _then;
}
...
class _$_Unexpected implements _Unexpected {
  ...
  @override
  String toString() {
    return 'ArticleTermCountFailure.unexpected()';
  }
...
class _$_InsufficientPermissions implements _InsufficientPermissions {
  ...
  @override
  String toString() {
    return 'ArticleTermCountFailure.insufficientPermissions()';
  }
...
abstract class _InsufficientPermissions implements ArticleTermCountFailure {
